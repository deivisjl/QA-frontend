...
import { Checkbox, FormControl, FormControlLabel, FormGroup, FormHelperText, FormLabel, InputLabel, MenuItem, Select, Typography } from '@mui/material';
...
export default function CrearRoles(){
  ...
  const handleSubmit = (e) =>{
    ...
    RolService.registrar({nombre,permisos:permisosSeleccionados,usuario:currentUser.id})
        .then(res => {
